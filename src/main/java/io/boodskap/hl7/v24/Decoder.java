...
public class Decoder implements MessageDecoder {
	...
	public void decode(HapiContext context, Parser parser, Message msg, JSONObject json, String data) throws Exception {
		...
		for (String type : msg.getNames()) {
			...
			else if(s instanceof QBP_Q13_QBP){
				QBP_Q13_QBP v = (QBP_Q13_QBP) s;
			} 
			...
			else if(s instanceof RSP_K13_ROW_DEFINITION){
				RSP_K13_ROW_DEFINITION v = (RSP_K13_ROW_DEFINITION) s;
			} 
			...
			else if(s instanceof ORL_O22_GENERAL_ORDER){
				ORL_O22_GENERAL_ORDER v = (ORL_O22_GENERAL_ORDER) s;
			} 
			...
			else if(s instanceof OML_O21_CONTAINER_1){
				OML_O21_CONTAINER_1 v = (OML_O21_CONTAINER_1) s;
			} 

			else if(s instanceof OML_O21_CONTAINER_2){
				OML_O21_CONTAINER_2 v = (OML_O21_CONTAINER_2) s;
			} 
			...
			else if(s instanceof ORF_R04_RESPONSE){
				ORF_R04_RESPONSE v = (ORF_R04_RESPONSE) s;
			} 
			...
			else if(s instanceof RGR_RGR_DEFINTION){
				RGR_RGR_DEFINTION v = (RGR_RGR_DEFINTION) s;
			} 
			...
			else if(s instanceof ORS_O06_RSPONSE){
				ORS_O06_RSPONSE v = (ORS_O06_RSPONSE) s;
			} 
			...
			else if(s instanceof OML_O21_ORDER_GENERAL){
				OML_O21_ORDER_GENERAL v = (OML_O21_ORDER_GENERAL) s;
			} 
			...
			else if(s instanceof RTB_Q13_ROW_DEFINITION){
				RTB_Q13_ROW_DEFINITION v = (RTB_Q13_ROW_DEFINITION) s;
			} 
			...
			else if(s instanceof RSP_Z82_PATIENT_VISIT){
				RSP_Z82_PATIENT_VISIT v = (RSP_Z82_PATIENT_VISIT) s;
			} 
			...
			else if(s instanceof QBP_K13_ROW_DEFINITION){
				QBP_K13_ROW_DEFINITION v = (QBP_K13_ROW_DEFINITION) s;
			} 
			...
			else if(s instanceof ORL_O22_CONTAINER){
				ORL_O22_CONTAINER v = (ORL_O22_CONTAINER) s;
			} 
