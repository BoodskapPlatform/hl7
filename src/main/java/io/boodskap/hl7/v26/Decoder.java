...
public class Decoder implements MessageDecoder {
	...
	public void decode(HapiContext context, Parser parser, Message msg, JSONObject json, String data) throws Exception {
		...
		for (String type : msg.getNames()) {
			...
			else if(s instanceof MFR_M06_MF_PHASE_SCHED_DETAIL){
				MFR_M06_MF_PHASE_SCHED_DETAIL v = (MFR_M06_MF_PHASE_SCHED_DETAIL) s;
			} 
			...
			else if(s instanceof MFR_M05_MF_LOC_DEPT){
				MFR_M05_MF_LOC_DEPT v = (MFR_M05_MF_LOC_DEPT) s;
			} 
