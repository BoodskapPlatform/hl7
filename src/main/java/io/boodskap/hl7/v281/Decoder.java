...
import ca.uhn.hl7v2.model.v281.message.*;
...
public class Decoder implements MessageDecoder {
	...
	public void decode(HapiContext context, Parser parser, Message msg, JSONObject json, String data) throws Exception {
		...
		for (String type : msg.getNames()) {
			...
			else if(s instanceof DPR_O48_OBRNTE){
				DPR_O48_OBRNTE v = (DPR_O48_OBRNTE) s;
			} 
			...
			else if(s instanceof ORL_O41_ORDER){
				ORL_O41_ORDER v = (ORL_O41_ORDER) s;
			} 
			...
			else if(s instanceof ORL_O43_SPECIMEN){
				ORL_O43_SPECIMEN v = (ORL_O43_SPECIMEN) s;
			} 
			...
			else if(s instanceof ORL_O43_SPECIMEN_OBSERVATION){
				ORL_O43_SPECIMEN_OBSERVATION v = (ORL_O43_SPECIMEN_OBSERVATION) s;
			} 
			...
			else if(s instanceof ORL_O43_RESPONSE){
				ORL_O43_RESPONSE v = (ORL_O43_RESPONSE) s;
			} 
			...
			else if(s instanceof CSU_C09_ORCPRT){
				CSU_C09_ORCPRT v = (CSU_C09_ORCPRT) s;
			} 
			...
			else if(s instanceof ORL_O44_SPECIMEN_CONTAINER_IN_PACKAGE){
				ORL_O44_SPECIMEN_CONTAINER_IN_PACKAGE v = (ORL_O44_SPECIMEN_CONTAINER_IN_PACKAGE) s;
			} 
			...
			else if(s instanceof DEO_O45_DONATION_ORDER){
				DEO_O45_DONATION_ORDER v = (DEO_O45_DONATION_ORDER) s;
			} 
			...
			else if(s instanceof ORL_O41_TIMING){
				ORL_O41_TIMING v = (ORL_O41_TIMING) s;
			} 
			...
			else if(s instanceof ORL_O41_SPECIMEN){
				ORL_O41_SPECIMEN v = (ORL_O41_SPECIMEN) s;
			} 

			else if(s instanceof ORL_O43_SPECIMEN_CONTAINER){
				ORL_O43_SPECIMEN_CONTAINER v = (ORL_O43_SPECIMEN_CONTAINER) s;
			} 
			...
			else if(s instanceof ORL_O43_PATIENT){
				ORL_O43_PATIENT v = (ORL_O43_PATIENT) s;
			} 
			...
			else if(s instanceof ORL_O43_ORDER){
				ORL_O43_ORDER v = (ORL_O43_ORDER) s;
			} 
			...
			else if(s instanceof ORL_O42_ORDER){
				ORL_O42_ORDER v = (ORL_O42_ORDER) s;
			} 
			...
			else if(s instanceof ORL_O44_SPECIMEN_IN_PACKAGE){
				ORL_O44_SPECIMEN_IN_PACKAGE v = (ORL_O44_SPECIMEN_IN_PACKAGE) s;
			} 
			...
			else if(s instanceof ORL_O43_TIMING){
				ORL_O43_TIMING v = (ORL_O43_TIMING) s;
			} 

			else if(s instanceof ORL_O44_SPECIMEN_SHIPMENT){
				ORL_O44_SPECIMEN_SHIPMENT v = (ORL_O44_SPECIMEN_SHIPMENT) s;
			} 
			...
			else if(s instanceof ORL_O42_RESPONSE){
				ORL_O42_RESPONSE v = (ORL_O42_RESPONSE) s;
			} 
			...
			else if(s instanceof ORL_O44_OBSERVATION_REQUEST){
				ORL_O44_OBSERVATION_REQUEST v = (ORL_O44_OBSERVATION_REQUEST) s;
			} 
			...
			else if(s instanceof DRC_O47_OBRNTE){
				DRC_O47_OBRNTE v = (DRC_O47_OBRNTE) s;
			} 
			...
			else if(s instanceof ORL_O44_PATIENT){
				ORL_O44_PATIENT v = (ORL_O44_PATIENT) s;
			} 
			...
			else if(s instanceof ORL_O42_SPECIMEN_OBSERVATION){
				ORL_O42_SPECIMEN_OBSERVATION v = (ORL_O42_SPECIMEN_OBSERVATION) s;
			} 
			...
			else if(s instanceof ORL_O41_PATIENT){
				ORL_O41_PATIENT v = (ORL_O41_PATIENT) s;
			} 
			...
			else if(s instanceof ORL_O44_RESPONSE){
				ORL_O44_RESPONSE v = (ORL_O44_RESPONSE) s;
			} 
			...
			else if(s instanceof ORL_O44_ORDER){
				ORL_O44_ORDER v = (ORL_O44_ORDER) s;
			} 
			...
			else if(s instanceof ORL_O44_TIMING){
				ORL_O44_TIMING v = (ORL_O44_TIMING) s;
			} 
			...
			else if(s instanceof DEO_O45_DONATION_OBSERVATION){
				DEO_O45_DONATION_OBSERVATION v = (DEO_O45_DONATION_OBSERVATION) s;
			} 
			...
			else if(s instanceof ORL_O41_RESPONSE){
				ORL_O41_RESPONSE v = (ORL_O41_RESPONSE) s;
			} 
			...
			else if(s instanceof OMQ_O42_ORDER_DOCUMENT){
				OMQ_O42_ORDER_DOCUMENT v = (OMQ_O42_ORDER_DOCUMENT) s;
			} 
			...
			else if(s instanceof ORL_O41_OBSERVATION_REQUEST){
				ORL_O41_OBSERVATION_REQUEST v = (ORL_O41_OBSERVATION_REQUEST) s;
			} 
			...
			else if(s instanceof ORL_O43_OBSERVATION_REQUEST){
				ORL_O43_OBSERVATION_REQUEST v = (ORL_O43_OBSERVATION_REQUEST) s;
			} 
			...
			else if(s instanceof ORL_O42_TIMING){
				ORL_O42_TIMING v = (ORL_O42_TIMING) s;
			} 
			...
			else if(s instanceof DER_O44_DONATION_ORDER){
				DER_O44_DONATION_ORDER v = (DER_O44_DONATION_ORDER) s;
			} 

			else if(s instanceof ORL_O44_PACKAGE){
				ORL_O44_PACKAGE v = (ORL_O44_PACKAGE) s;
			} 
			...
			else if(s instanceof ORL_O42_PATIENT){
				ORL_O42_PATIENT v = (ORL_O42_PATIENT) s;
			} 
			...
			else if(s instanceof ORL_O43){
				ORL_O43 v = (ORL_O43) s;
			} 

			else if(s instanceof ORL_O42_OBSERVATION_REQUEST){
				ORL_O42_OBSERVATION_REQUEST v = (ORL_O42_OBSERVATION_REQUEST) s;
			} 
			...
			else if(s instanceof ORL_O42_SPECIMEN){
				ORL_O42_SPECIMEN v = (ORL_O42_SPECIMEN) s;
			} 
