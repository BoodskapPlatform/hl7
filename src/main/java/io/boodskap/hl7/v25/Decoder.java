...
public class Decoder implements MessageDecoder {
	...
	public void decode(HapiContext context, Parser parser, Message msg, JSONObject json, String data) throws Exception {
		...
		for (String type : msg.getNames()) {
			...
			else if(s instanceof OUL_R23_SPMOBXSACINVOBRORCNTETQ1TQ2OBXTCDSIDNTECTI){
				OUL_R23_SPMOBXSACINVOBRORCNTETQ1TQ2OBXTCDSIDNTECTI v = (OUL_R23_SPMOBXSACINVOBRORCNTETQ1TQ2OBXTCDSIDNTECTI) s;
			} 
			...
			else if(s instanceof RPA_I08_AUTHORIZATION_2){
				RPA_I08_AUTHORIZATION_2 v = (RPA_I08_AUTHORIZATION_2) s;
			} 
			...
			else if(s instanceof RPA_I08_AUTHORIZATION_1){
				RPA_I08_AUTHORIZATION_1 v = (RPA_I08_AUTHORIZATION_1) s;
			} 
			...
			else if(s instanceof ORL_O34_ORDER_SPECIMEN){
				ORL_O34_ORDER_SPECIMEN v = (ORL_O34_ORDER_SPECIMEN) s;
			} 
