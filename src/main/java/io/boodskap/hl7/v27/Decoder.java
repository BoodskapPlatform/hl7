...
public class Decoder implements MessageDecoder {
	...
	public void decode(HapiContext context, Parser parser, Message msg, JSONObject json, String data) throws Exception {
		...
		for (String type : msg.getNames()) {
			...
			else if(s instanceof RSP_E03_INVOICE_PROCESSING_RESULTS_INFO){
				RSP_E03_INVOICE_PROCESSING_RESULTS_INFO v = (RSP_E03_INVOICE_PROCESSING_RESULTS_INFO) s;
			} 
			...
			else if(s instanceof OPL_O37_TIMING2){
				OPL_O37_TIMING2 v = (OPL_O37_TIMING2) s;
			} 
			...
			else if(s instanceof EHC_E10_PRODUCT_SERVICE_SECTION){
				EHC_E10_PRODUCT_SERVICE_SECTION v = (EHC_E10_PRODUCT_SERVICE_SECTION) s;
			} 
			...
			else if(s instanceof EHC_E01_INVOICE_PROCESSING){
				EHC_E01_INVOICE_PROCESSING v = (EHC_E01_INVOICE_PROCESSING) s;
			} 
			...
			else if(s instanceof RPA_I08_AUTHORIZATION2){
				RPA_I08_AUTHORIZATION2 v = (RPA_I08_AUTHORIZATION2) s;
			} 
			...
			else if(s instanceof EHC_E24_PAYER_ADJUSTMENT){
				EHC_E24_PAYER_ADJUSTMENT v = (EHC_E24_PAYER_ADJUSTMENT) s;
			} 
			...
			else if(s instanceof RQA_I08_AUTHORIZATION2){
				RQA_I08_AUTHORIZATION2 v = (RQA_I08_AUTHORIZATION2) s;
			} 
			...
			else if(s instanceof EHC_E10_PRODUCT_SERVICE_GROUP){
				EHC_E10_PRODUCT_SERVICE_GROUP v = (EHC_E10_PRODUCT_SERVICE_GROUP) s;
			} 
